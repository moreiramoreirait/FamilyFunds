...
Opcionais: `MAIL_HOST`, `MAIL_PORT`, `MAIL_USERNAME`, `MAIL_PASSWORD`, `MAIL_FROM` (remetente — obrigatório no Brevo: sender verificado), `BREVO_API_KEY` (envia via API HTTP do Brevo — **necessário no Render**, que bloqueia SMTP)
